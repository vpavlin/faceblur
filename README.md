...
- 🔒 **100% Client-Side Processing** - All face detection happens in your browser
- 🌫️ **Blur Faces** - Apply blur effect to detected faces
- 😊 **Emoji Replacement** - Replace faces with 20+ emojis
- 🖼️ **Custom Images** - Upload your own images to cover faces
- 🎯 **Adjustable Sensitivity** - Fine-tune face detection
- ✕ **Selective Processing** - Choose which faces to process
- 💾 **Download Results** - Save your privacy-protected photos
...
- ✅ Custom images stored locally in your browser
...
3. Click ✕ on faces you want to exclude
